...
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) ⭐82k | [`~/.claude/.credentials.json` 的容器非空时，Claude 凭据加载器抛 `AttributeError`](https://github.com/bytedance/deer-flow/issues/5473) `2026-09-16` | 🟡 已提交，等待确认 |
